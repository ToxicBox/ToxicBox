...
function image_start_load (){
  $('body')
    .prepend('<img src="'+iu+'loader.gif" alt="" id="toxic_loading" style="top:0;margin-top:'+((height/2-20)+$(window).scrollTop())+'px;margin-left:'+(width/2 - 20+$(window).scrollLeft())+'px;"  />');
}
    ...
    $(".toxic_current")
      .on('load', function() {
        ...
        if(ct){	
          ...
          if (is_single==1 ) {
              ttx
                .html('<p class="toxic_center toxic_title" style="width:'+($(this).width()-40)+'px;margin-bottom:'+ps+'px;">'+ct+'</p>');
          }
        }else{
          if ( (is_single == 2)||(is_single == 21)||(is_single == 22) ) {
              ttx
        ...
        ch=ttx.height()+ch;
        ts
          .prepend('<a href="#index" class="toxic_links"><img id="toxic_close" class="toxic_hidden toxic_images_close" src="'+iu+'close.png" alt="" /></a>');
        $('#toxic_close')
...
function GetDataToxic() {
  ...
  ci=ai.length;
    ...
    $('body')
      .append('<div id="toxic_dark" class="toxic_images_close"></div><div id="toxic_showbox" style="height:'+old_height+'px;width:'+old_width+'px;' +
...
function GetDataToxicDatabox(id,title) {
    ...
    $('body')
      .append('<div id="toxic_dark" class="toxic_div_close"></div><div id="toxic_showbox" style="height:'+old_height+'px;width:'+old_width+'px;' +
              'left:'+(width/2-ps-old_width/2+$(window).scrollLeft())+'px;top:'+((height)/2-ps-old_height/2+$(window).scrollTop())+'px;padding:'+ps+'px;"></div>');
    var ts=$("#toxic_showbox"),
    ...
    if (istitle) {
      ts
        .prepend('<h2 id="toxic_h2" style="width:'+cw+'px;margin-bottom:'+ps+'px;" class="toxic_hidden toxic_center">'+istitle+'</h2>');
    ...
    ts
      ...
      function() {
        ...
        ts
          .append(current_databox, '<a href="#index" class="toxic_links"><img id="toxic_close" class="toxic_hidden toxic_div_close" src="'+iu+'close.png" alt="" /></a>')
...
function GetDataToxicAlert(title) {
  ...
  $('body')
    .append('<div id="toxic_dark" class="toxic_images_close"></div><div id="toxic_showbox" class="alert" style="height:'+old_height+'px;width:'+old_width+'px;' +
            'left:'+(width/2-ps-old_width/2+$(window).scrollLeft())+'px;top:'+((height)/2-ps-old_height/2+$(window).scrollTop())+'px;padding:'+ps+'px;"></div>');
  var ts=$("#toxic_showbox");
  ts
  ...
  ts
    ...
    function() {
      ...
      tsp
        .velocity("fadeIn",150/sp);
      $('#toxic_close.toxic_images_close')
...
if (!old_width) {
  ...
  if($('#toxic_showbox').find('.toxic_div_close').length){
    $('body')
...
function pre_close_all() {
  if ($('#toxic_showbox').is(':visible')) {
    old_width=$('#toxic_showbox').width();
    old_height=$('#toxic_showbox').height();
  }
  $('#toxic_dark, #toxic_showbox, #toxic_loading').css('display','none');
  close_function_progress();
}
return {
