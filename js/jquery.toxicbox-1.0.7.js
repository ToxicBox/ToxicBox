...
function GetImages(ct){
  ...
  function fix_img_height(correct){
    ...
    ts
      .prepend('<img src="'+$(cd).attr('href')+'" alt="" class="toxic_current toxic_hidden" style="max-width:'+(width-ps*2)+'px;max-height:'+height+'px;" /><div id="toxic_textarea" class="toxic_hidden" style="min-height:'+(41+ps)+'px;margin-top:'+ps+'px;padding-top:3px;"></div>');
