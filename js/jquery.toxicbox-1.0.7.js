...
function GetImages(ct){
  ...
  function fix_img_height(correct){
    ...
    ts
      .prepend('<img src="'+$(cd).attr('href')+'" alt="" class="toxic_current toxic_hidden" style="max-width:'+(width-ps*2)+'px;max-height:'+height+'px;" /><div id="toxic_textarea" class="toxic_hidden" style="min-height:'+(41+ps)+'px;margin-top:'+ps+'px;"></div>');
        ...
        if(ct){	
          if (is_single==2 ) {
              ttx
                ...
                .html('<div id="toxic_arrow_carrier" style="width:'+cw+'px;"><div class="toxic_left toxic_larrow" style="margin-left:-20px;" ><a href="#back"><img src="'+iu+'left.png" alt="" /></a></div><div class="toxic_left toxic_rarrow"><a href="#next"><img src="'+iu+'right.png" alt="" /></a></div></div><p class="toxic_center countofimages">'+cl.im+' '+cin+' '+cl.o+' '+ci+'</p><p class="toxic_center toxic_title" style="margin-bottom:'+ps+'px;">'+ct+'</p>');
                chk_arrow();
          }
          if (is_single==1 ) {
              ttx
                .html('<p class="toxic_center toxic_title" style="width:'+($(this).width()-40)+'px;paddingTop:4px;">'+ct+'</p>');
          }
        }else{
          if (is_single==2 ) {
              ttx
...
function GetDataToxicDatabox(id,title) {
    ...
    if (istitle) {
      ...
      ch += parseInt($('#toxic_h2').css('height'))+parseInt($('#toxic_h2').css('marginTop'))+parseInt($('#toxic_h2').css('marginBottom'))+parseInt($('#toxic_h2').css( 'paddingTop'))+parseInt($('#toxic_h2').css( 'paddingBottom'));
    }	
    ts
      .velocity( {
        width:cw,
